...
function drawText() {
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "to be alive, and to get to spend this life with you Paurnima 🥰",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity += 0.01;
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["and yet here I am to get the impossible", "chance to be your BF 😎"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 3000 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["I love you so much,", "more than anything so I deserve countless biscuits 😁"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
